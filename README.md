...
- **_Note:_** - Review the Kubernetes manifest files located in `./k8s-manifest`. and you should change image name & tag with your own image

```bash
kubectl apply -k k8s-manifests/
```

- 👉 **_Note_**: wait for 5 minutes till you load balancer comes in running state
...
- **_Note:_** Keep the script running in another terminal to quickly gather metrics & traces.
